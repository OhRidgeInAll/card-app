...
export default async function MtgDeckDetailPage({ params }: Props) {
    ...
    <div>
      <div className="d-flex justify-content-between align-items-center mb-2">
        ...
        <div className="d-flex gap-3">
          <Link href={`/mtg/decks/${deck.id}/add`} className="link-underline small">
            + Add cards
          </Link>
          <Link href="/mtg/decks" className="link-underline small">
            All decks
          </Link>
        </div>
      </div>
